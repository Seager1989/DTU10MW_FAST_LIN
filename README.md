...
If you use this model in your publication, please refer to and cite the following reference.

Du, X., Liang, J., Muro, J. L., Qian, G., Burlion, L., & Bilgen, O. (2024). Development of a control co-design optimization framework with aeroelastic-control coupling for floating offshore wind turbines. Applied Energy, 372, 123728.
